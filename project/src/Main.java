...
public class Main {
    public static void main(String[] args) {
        ...
        ProductDetails breadDetailsDay1 = new ProductDetails(bread.id, 1, 8, bread.price);
        ProductDetails breadDetailsDay2 = new ProductDetails(bread.id, 2, 7, bread.price+0.5);
        ProductDetails steakDetailsDay1 = new ProductDetails(steak.id, 1, 4, steak.price);
        ProductDetails steakDetailsDay2 = new ProductDetails(steak.id, 2, 6, steak.price-1);
